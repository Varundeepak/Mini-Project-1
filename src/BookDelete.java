...
public class BookDelete extends javax.swing.JFrame {
    ...
    String query;
    ResultSet rs;
    public BookDelete() throws Exception {
        initComponents();
    ...
    private void initComponents() {
        ...
        jRadioButton1.setText("Delete By Book ID");
        ...
        jRadioButton2.setText("Delete By Book Name");

        jRadioButton3.setText("Delete By Author Name");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try
        {
                ...
                if(jTextField1.getText().equals(""))
            {
                ...
                {
                    query="delete from books where bookid="+jTextField1.getText()+";";
                ...
                if(jTextField2.getText().equals(""))
            {
                ...
                {
                    query="delete from books where bookname='"+jTextField2.getText()+"';";
                    stmt.executeUpdate(query);
                    JOptionPane.showMessageDialog(this,"Deletion Successful");
                }
            }
                ...
                if(jTextField3.getText().equals(""))
            {
                ...
                {
                    query="delete from books where authorname='"+jTextField1.getText()+"';";
                    stmt.executeUpdate(query);
                    JOptionPane.showMessageDialog(this,"Deletion Successful");
                }
            }
