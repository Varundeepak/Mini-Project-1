...
public class DeleteMember extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jRadioButton1.setText("Delete By Member ID");

        jRadioButton2.setText("Delete By Member Name");

        jRadioButton3.setText("Delete By Contact No.");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try
        {
                ...
                if(jTextField1.getText().equals(""))
            {
                ...
                {
                    query="delete from member where memberid="+jTextField1.getText()+";";
                ...
                if(jTextField2.getText().equals(""))
            {
                ...
                {
                    query="delete from member where membername='"+jTextField2.getText()+"';";
                    stmt.executeUpdate(query);
                    JOptionPane.showMessageDialog(this,"Deletion Successful");
                }
            }
                ...
                if(jTextField3.getText().equals(""))
            {
                ...
                {
                    query="delete from member where contact='"+jTextField1.getText()+"';";
                    stmt.executeUpdate(query);
                    JOptionPane.showMessageDialog(this,"Deletion Successful");
                }
            }
