...
public class AdminAuth extends javax.swing.JFrame {
    ...
    String query;
    ResultSet rs;
    public AdminAuth() throws Exception {
        initComponents();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try
        {
            query="select * from login where username='"+jTextField1.getText()+"';";
            rs=stmt.executeQuery(query);
            rs.next();
            String user=rs.getString("username");
            String pass=rs.getString("password");
            char[] abc=jPasswordField1.getPassword();
            String xyz=new String(abc);
            if(user.equals(jTextField1.getText()) && pass.equals(xyz))
            {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            ...
            Logger.getLogger(AdminAuth.class.getName()).log(Level.SEVERE, null, ex);
        }
        m.setVisible(true);
        this.setVisible(false);
